package com.yelp.web.search.controller.api;

import com.yelp.web.search.config.RabbitMQConfig;
 ...
 */
@RestController
public class MqTestApiController implements RabbitTemplate.ConfirmCallback{
     ...
     */
    public MqTestApiController(RabbitTemplate rabbitTemplate){
     ...
     * @return
     */
    @GetMapping("mqtest/send1")
    public String send1Message(String msg){
